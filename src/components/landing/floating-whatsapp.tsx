  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100] group">
      ...
      <a
        ...
        className="relative flex items-center gap-3 bg-green-500 text-white px-5 py-3 rounded-full shadow-2xl hover:bg-green-600 transition-all hover:scale-105 active:scale-95"
      >
        {/* Urutan: Logo lalu Tulisan */}
        <MessageCircle className="h-5 w-5 sm:h-6 sm:w-6" />
        <span className="font-bold text-xs sm:text-sm tracking-wide">Chat Admin</span>
